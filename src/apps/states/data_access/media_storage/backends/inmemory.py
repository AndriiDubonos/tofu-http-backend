...
from apps.common.unit_of_work.units.media_storage import InMemoryMediaStorageUnit, MediaStore
...
class InMemoryMediaStorageBackend(BaseMediaStorageBackend):
    async def _get_media_storage(self) -> MediaStore:
        media_storage_unit = cast(InMemoryMediaStorageUnit, await self._unit_of_work.get_unit(UnitType.MEDIA_STORAGE))
